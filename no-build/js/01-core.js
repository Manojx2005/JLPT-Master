...
/* -----------------------------------------------------------------
   ...
   ----------------------------------------------------------------- */
var useState = React.useState;       // State management hook
var useEffect = React.useEffect;     // Side-effect hook (timers, subscriptions)
var useRef = React.useRef;           // Mutable ref container (persists across renders)
var useCallback = React.useCallback; // Memoized callback (prevents unnecessary re-renders)
var useMemo = React.useMemo;         // Memoized computed value
...
var createElement = React.createElement; // Virtual DOM element factory
