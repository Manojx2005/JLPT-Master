...
var GRAMMAR_DATA = [
    ...
    // ===== N5 Grammar (expanded) =====
    { pattern: "か", meaning: "Question particle", level: "N5", structure: "文 + か", examples: [{ jp: "学生（がくせい）ですか。", en: "Are you a student?" }], notes: "Placed at the end of a sentence to make a question." },
    { pattern: "ね", meaning: "Right? / isn't it? (agreement)", level: "N5", structure: "文 + ね", examples: [{ jp: "いい天気（てんき）ですね。", en: "Nice weather, isn't it?" }], notes: "Seeks agreement or shared feeling with the listener." },
    { pattern: "よ", meaning: "You know (emphasis / new info)", level: "N5", structure: "文 + よ", examples: [{ jp: "この店（みせ）は安（やす）いですよ。", en: "This shop is cheap, you know." }], notes: "Tells the listener something they may not know." },
    { pattern: "へ", meaning: "To / toward (direction)", level: "N5", structure: "名 + へ", examples: [{ jp: "学校（がっこう）へ行（い）きます。", en: "I go to school." }], notes: "Marks direction of movement; pronounced 'e'." },
    { pattern: "から〜まで", meaning: "From ~ to ~", level: "N5", structure: "名 + から + 名 + まで", examples: [{ jp: "九時（くじ）から五時（ごじ）まで働（はたら）きます。", en: "I work from 9 to 5." }], notes: "Range of time or place (start and end)." },
    { pattern: "ませんか", meaning: "Won't you ~? (invitation)", level: "N5", structure: "動ます-stem + ませんか", examples: [{ jp: "一緒（いっしょ）に食（た）べませんか。", en: "Won't you eat with me?" }], notes: "Polite invitation or suggestion." },
    { pattern: "ましょう", meaning: "Let's ~", level: "N5", structure: "動ます-stem + ましょう", examples: [{ jp: "始（はじ）めましょう。", en: "Let's begin." }], notes: "Proposes doing something together." },
    { pattern: "ましょうか", meaning: "Shall I / shall we ~?", level: "N5", structure: "動ます-stem + ましょうか", examples: [{ jp: "窓（まど）を開（あ）けましょうか。", en: "Shall I open the window?" }], notes: "Offers help or proposes an action." },
    { pattern: "でしょう", meaning: "Probably / right?", level: "N5", structure: "普通形 + でしょう", examples: [{ jp: "明日（あした）は晴（は）れるでしょう。", en: "It will probably be sunny tomorrow." }], notes: "Conjecture, or seeks agreement with rising intonation." },
    { pattern: "が (but)", meaning: "But / however", level: "N5", structure: "文 + が", examples: [{ jp: "高（たか）いですが、買（か）います。", en: "It's expensive, but I'll buy it." }], notes: "Contrastive conjunction joining two clauses (different from subject-marker が)." },
    { pattern: "もう", meaning: "Already", level: "N5", structure: "もう + 動ました", examples: [{ jp: "もう昼（ひる）ご飯（はん）を食（た）べました。", en: "I already ate lunch." }], notes: "Indicates completion; with a negative it means 'not anymore'." },
    { pattern: "まだ", meaning: "Still / not yet", level: "N5", structure: "まだ + 動ています／ていません", examples: [{ jp: "まだ食（た）べていません。", en: "I haven't eaten yet." }], notes: "Continuation, or (with negative) something not yet done." },
    { pattern: "より", meaning: "Than (comparison)", level: "N5", structure: "名 + より", examples: [{ jp: "電車（でんしゃ）は車（くるま）より速（はや）いです。", en: "The train is faster than the car." }], notes: "Marks the standard being compared against." },
    { pattern: "一番（いちばん）", meaning: "The most (superlative)", level: "N5", structure: "一番 + 形／副", examples: [{ jp: "このケーキが一番（いちばん）おいしい。", en: "This cake is the most delicious." }], notes: "Expresses the superlative degree." },
    { pattern: "ほうがいい", meaning: "Had better / it's better to", level: "N5", structure: "動た形 + ほうがいい", examples: [{ jp: "早（はや）く寝（ね）たほうがいい。", en: "You had better sleep early." }], notes: "Gives advice or a recommendation." },
    { pattern: "前（まえ）に", meaning: "Before ~", level: "N5", structure: "動辞書形／名の + 前に", examples: [{ jp: "寝（ね）る前（まえ）に歯（は）を磨（みが）きます。", en: "I brush my teeth before sleeping." }], notes: "Marks the action that comes first in time." },
    { pattern: "てから", meaning: "After doing ~", level: "N5", structure: "動て形 + から", examples: [{ jp: "ご飯（はん）を食（た）べてから出（で）かけます。", en: "I go out after eating." }], notes: "Shows a clear sequence of two actions." },
    { pattern: "とき", meaning: "When ~", level: "N5", structure: "動普通形／名の + とき", examples: [{ jp: "子供（こども）のとき、よく遊（あそ）んだ。", en: "When I was a child, I played a lot." }], notes: "Marks the time or occasion of an event." },
    { pattern: "だけ", meaning: "Only / just", level: "N5", structure: "名 + だけ", examples: [{ jp: "水（みず）だけ飲（の）みます。", en: "I drink only water." }], notes: "Limitation with a neutral or positive nuance." },
    { pattern: "しか〜ない", meaning: "Only (with negative)", level: "N5", structure: "名 + しか 〜 ない", examples: [{ jp: "百円（ひゃくえん）しかない。", en: "I only have 100 yen." }], notes: "Emphasized limitation; always paired with a negative verb." },
    { pattern: "ぐらい／くらい", meaning: "About / approximately", level: "N5", structure: "数量 + ぐらい", examples: [{ jp: "三十分（さんじゅっぷん）ぐらい待（ま）った。", en: "I waited about 30 minutes." }], notes: "Approximate quantity or extent." },
    { pattern: "ごろ", meaning: "Around (a point in time)", level: "N5", structure: "時間 + ごろ", examples: [{ jp: "三時（さんじ）ごろ来（き）ます。", en: "I'll come around 3 o'clock." }], notes: "Approximate point in time (not duration)." },
    { pattern: "ずつ", meaning: "Each / apiece", level: "N5", structure: "数量 + ずつ", examples: [{ jp: "一（ひと）つずつ取（と）ってください。", en: "Please take one each." }], notes: "Equal distribution or repetition." },
    { pattern: "たり〜たり", meaning: "Do things like ~ and ~", level: "N5", structure: "動た形 + り 〜 動た形 + り + する", examples: [{ jp: "週末（しゅうまつ）は掃除（そうじ）したり洗濯（せんたく）したりする。", en: "On weekends I do things like cleaning and laundry." }], notes: "Non-exhaustive list of representative actions." },
    { pattern: "のが／ことが好（す）き", meaning: "Like doing ~", level: "N5", structure: "動辞書形 + の／こと + が好き", examples: [{ jp: "音楽（おんがく）を聞（き）くのが好（す）きです。", en: "I like listening to music." }], notes: "Nominalizes a verb to express a preference." },
    { pattern: "がほしい", meaning: "Want (something)", level: "N5", structure: "名 + がほしい", examples: [{ jp: "新（あたら）しい車（くるま）がほしい。", en: "I want a new car." }], notes: "Expresses desire for an object (not an action)." },
    { pattern: "でも", meaning: "~ or something (soft suggestion)", level: "N5", structure: "名 + でも", examples: [{ jp: "お茶（ちゃ）でも飲（の）みませんか。", en: "Would you like some tea or something?" }], notes: "Offers an example softly without limiting the choice." },
    { pattern: "くなる／になる", meaning: "Become ~", level: "N5", structure: "い-adj く／な-adj・名 に + なる", examples: [{ jp: "寒（さむ）くなりました。", en: "It has gotten cold." }], notes: "Expresses a change of state." },
    { pattern: "すぎる", meaning: "Too much / excessively", level: "N5", structure: "動ます-stem／形-stem + すぎる", examples: [{ jp: "食（た）べすぎました。", en: "I ate too much." }], notes: "Indicates an excessive degree, usually negative." },
    { pattern: "方（かた）", meaning: "How to ~ / way of doing", level: "N5", structure: "動ます-stem + 方", examples: [{ jp: "漢字（かんじ）の書（か）き方（かた）を教（おし）えてください。", en: "Please teach me how to write kanji." }], notes: "Turns a verb into 'the way/method of doing it'." },
    { pattern: "んです／のです", meaning: "Explanatory ~ (the thing is)", level: "N5", structure: "普通形 + んです", examples: [{ jp: "頭（あたま）が痛（いた）いんです。", en: "The thing is, my head hurts." }], notes: "Gives an explanation, reason, or background." },
    { pattern: "ないでください", meaning: "Please don't ~", level: "N5", structure: "動ない形 + でください", examples: [{ jp: "ここで写真（しゃしん）を撮（と）らないでください。", en: "Please don't take photos here." }], notes: "Polite negative request." },
    { pattern: "く／に (adverb)", meaning: "Adverbial form of adjectives", level: "N5", structure: "い-adj → く ／ な-adj → に", examples: [{ jp: "早（はや）く起（お）きます。", en: "I get up early." }], notes: "Turns an adjective into an adverb modifying a verb." },
    { pattern: "くて／で (linking)", meaning: "And (linking adjectives)", level: "N5", structure: "い-adj くて ／ な-adj・名 で", examples: [{ jp: "この部屋（へや）は広（ひろ）くて明（あか）るい。", en: "This room is spacious and bright." }], notes: "Connects adjective or noun clauses." },
    { pattern: "に行（い）く (purpose)", meaning: "Go to (do) ~", level: "N5", structure: "動ます-stem + に + 行く／来る", examples: [{ jp: "映画（えいが）を見（み）に行（い）きます。", en: "I'm going to see a movie." }], notes: "Marks the purpose of coming or going." },
    { pattern: "という", meaning: "Called ~ / named ~", level: "N5", structure: "名 + という + 名", examples: [{ jp: "これは寿司（すし）という食（た）べ物（もの）です。", en: "This is a food called sushi." }], notes: "Introduces or names something." },
    ...
    // ===== N4 Grammar (expanded) =====
    { pattern: "可能形（かのうけい）", meaning: "Can / be able to (potential)", level: "N4", structure: "動可能形（食べる→食べられる）", examples: [{ jp: "日本語（にほんご）が話（はな）せます。", en: "I can speak Japanese." }], notes: "Potential form expresses ability or possibility." },
    { pattern: "意向形（いこうけい）", meaning: "Let's / I'll (casual volition)", level: "N4", structure: "動意向形（行く→行こう）", examples: [{ jp: "映画（えいが）を見（み）よう。", en: "Let's watch a movie." }], notes: "Plain volitional form; casual equivalent of ましょう." },
    { pattern: "ようと思（おも）う", meaning: "Think I'll ~ / intend to", level: "N4", structure: "動意向形 + と思う", examples: [{ jp: "週末（しゅうまつ）は勉強（べんきょう）しようと思（おも）う。", en: "I'm thinking of studying this weekend." }], notes: "States the speaker's intention." },
    { pattern: "たがる", meaning: "Wants to ~ (third person)", level: "N4", structure: "動ます-stem + たがる", examples: [{ jp: "弟（おとうと）は外（そと）で遊（あそ）びたがる。", en: "My little brother wants to play outside." }], notes: "Describes someone else's visible desire." },
    { pattern: "かもしれない", meaning: "Might / maybe", level: "N4", structure: "普通形 + かもしれない", examples: [{ jp: "雨（あめ）が降（ふ）るかもしれない。", en: "It might rain." }], notes: "Expresses a possibility the speaker isn't sure about." },
    { pattern: "はず", meaning: "Should / supposed to be", level: "N4", structure: "普通形 + はず", examples: [{ jp: "彼（かれ）はもう着（つ）いたはずだ。", en: "He should have already arrived." }], notes: "Expectation based on reasoning or evidence." },
    { pattern: "使役（しえき）", meaning: "Make / let someone do", level: "N4", structure: "動使役形（する→させる）", examples: [{ jp: "母（はは）は妹（いもうと）に部屋（へや）を掃除（そうじ）させた。", en: "Mother made my sister clean the room." }], notes: "Causative form: compel or permit an action." },
    { pattern: "命令形（めいれいけい）", meaning: "Command form", level: "N4", structure: "動命令形（する→しろ）", examples: [{ jp: "早（はや）くしろ。", en: "Do it quickly." }], notes: "Strong, blunt command; used sparingly." },
    { pattern: "なさい", meaning: "Do ~ (gentle command)", level: "N4", structure: "動ます-stem + なさい", examples: [{ jp: "早（はや）く寝（ね）なさい。", en: "Go to bed early." }], notes: "Soft instruction used by parents/teachers." },
    { pattern: "てみる", meaning: "Try doing ~", level: "N4", structure: "動て形 + みる", examples: [{ jp: "この服（ふく）を着（き）てみる。", en: "I'll try wearing these clothes." }], notes: "Do something to see what happens." },
    { pattern: "ておく", meaning: "Do ~ in advance", level: "N4", structure: "動て形 + おく", examples: [{ jp: "旅行（りょこう）の前（まえ）に予約（よやく）しておく。", en: "I'll book in advance before the trip." }], notes: "Preparation for the future." },
    { pattern: "てしまう", meaning: "Do completely / unfortunately", level: "N4", structure: "動て形 + しまう", examples: [{ jp: "宿題（しゅくだい）を忘（わす）れてしまった。", en: "I completely forgot my homework." }], notes: "Completion, or regret over an outcome. Casual: ちゃう." },
    { pattern: "てある", meaning: "Has been done (state)", level: "N4", structure: "動て形 + ある", examples: [{ jp: "窓（まど）が開（あ）けてある。", en: "The window has been left open." }], notes: "Resultant state left intentionally by someone." },
    { pattern: "ていく／てくる", meaning: "Go on / come to ~ (change)", level: "N4", structure: "動て形 + いく／くる", examples: [{ jp: "だんだん寒（さむ）くなってきた。", en: "It has gradually gotten colder." }], notes: "Change over time or movement toward/away." },
    { pattern: "なくてもいい", meaning: "Don't have to ~", level: "N4", structure: "動ない形 + くてもいい", examples: [{ jp: "明日（あした）は来（こ）なくてもいい。", en: "You don't have to come tomorrow." }], notes: "Lack of necessity." },
    { pattern: "なくてはいけない", meaning: "Must / have to ~", level: "N4", structure: "動ない形 + くてはいけない", examples: [{ jp: "薬（くすり）を飲（の）まなくてはいけない。", en: "I must take medicine." }], notes: "Obligation. Casual: なくちゃ／なきゃ." },
    { pattern: "と (natural result)", meaning: "When / if (natural consequence)", level: "N4", structure: "動辞書形 + と", examples: [{ jp: "春（はる）になると花（はな）が咲（さ）く。", en: "When spring comes, flowers bloom." }], notes: "Inevitable or natural result of a condition." },
    { pattern: "なら", meaning: "If ~ (contextual condition)", level: "N4", structure: "名／普通形 + なら", examples: [{ jp: "日本語（にほんご）ならまかせて。", en: "If it's Japanese, leave it to me." }], notes: "Responds to a topic the other person raised." },
    { pattern: "ても", meaning: "Even if ~", level: "N4", structure: "動て形 + も", examples: [{ jp: "雨（あめ）が降（ふ）っても行（い）きます。", en: "Even if it rains, I'll go." }], notes: "Concessive condition." },
    { pattern: "らしい", meaning: "Seems / apparently", level: "N4", structure: "普通形 + らしい", examples: [{ jp: "彼（かれ）は忙（いそが）しいらしい。", en: "He seems to be busy." }], notes: "Inference based on information heard." },
    { pattern: "みたい", meaning: "Like / seems (casual)", level: "N4", structure: "名／普通形 + みたい", examples: [{ jp: "彼（かれ）は子供（こども）みたいだ。", en: "He's like a child." }], notes: "Resemblance or conjecture; casual form of ようだ." },
    { pattern: "ようだ", meaning: "Seems / appears (evidence)", level: "N4", structure: "普通形 + ようだ", examples: [{ jp: "誰（だれ）かいるようだ。", en: "It seems someone is here." }], notes: "Conjecture based on what the speaker senses." },
    { pattern: "ように言（い）う", meaning: "Tell someone to ~", level: "N4", structure: "動辞書形／ない + ように言う", examples: [{ jp: "医者（いしゃ）に休（やす）むように言（い）われた。", en: "The doctor told me to rest." }], notes: "Reports an indirect request or instruction." },
    { pattern: "場合（ばあい）", meaning: "In the case of ~", level: "N4", structure: "名の／普通形 + 場合", examples: [{ jp: "遅（おく）れる場合（ばあい）は連絡（れんらく）してください。", en: "In case you'll be late, please contact me." }], notes: "Introduces a hypothetical situation." },
    { pattern: "お〜になる", meaning: "Honorific (respectful)", level: "N4", structure: "お + 動ます-stem + になる", examples: [{ jp: "先生（せんせい）がお話（はな）しになる。", en: "The teacher speaks. (respectful)" }], notes: "Raises the status of the person doing the action." },
    { pattern: "お〜する", meaning: "Humble", level: "N4", structure: "お + 動ます-stem + する", examples: [{ jp: "お荷物（にもつ）をお持（も）ちします。", en: "I'll carry your luggage. (humble)" }], notes: "Lowers the speaker to show respect." },
    { pattern: "がる", meaning: "Show signs of (feeling)", level: "N4", structure: "形-stem + がる", examples: [{ jp: "妹（いもうと）は寂（さび）しがっている。", en: "My little sister seems lonely." }], notes: "Describes another person's outward emotions." },
    { pattern: "まま", meaning: "As it is / unchanged", level: "N4", structure: "動た形／名の + まま", examples: [{ jp: "電気（でんき）をつけたまま寝（ね）た。", en: "I slept with the light on." }], notes: "A state left unchanged while another action occurs." },
    ...
    // ===== N3 Grammar (expanded) =====
    { pattern: "はずがない", meaning: "Cannot be / no way", level: "N3", structure: "普通形 + はずがない", examples: [{ jp: "彼（かれ）がそんなことを言（い）うはずがない。", en: "There's no way he would say such a thing." }], notes: "Strong logical denial of a possibility." },
    { pattern: "べきだ", meaning: "Should / ought to", level: "N3", structure: "動辞書形 + べきだ", examples: [{ jp: "約束（やくそく）は守（まも）るべきだ。", en: "You should keep your promises." }], notes: "Strong opinion about the right thing to do (する→すべき)." },
    { pattern: "ものだ", meaning: "It's the way it is / should", level: "N3", structure: "動辞書形 + ものだ", examples: [{ jp: "年（とし）を取（と）ると忘（わす）れっぽくなるものだ。", en: "People naturally become forgetful with age." }], notes: "General truth, common sense, or nostalgia." },
    { pattern: "ということだ", meaning: "I hear that / it means", level: "N3", structure: "普通形 + ということだ", examples: [{ jp: "会議（かいぎ）は延期（えんき）になったということだ。", en: "I hear the meeting was postponed." }], notes: "Reports information or draws a conclusion." },
    { pattern: "によると", meaning: "According to ~", level: "N3", structure: "名 + によると", examples: [{ jp: "天気予報（てんきよほう）によると、明日（あした）は雪（ゆき）だ。", en: "According to the forecast, it'll snow tomorrow." }], notes: "States the source of information (often with そうだ)." },
    { pattern: "としても", meaning: "Even if / even supposing", level: "N3", structure: "普通形 + としても", examples: [{ jp: "高（たか）いとしても買（か）います。", en: "Even if it's expensive, I'll buy it." }], notes: "Hypothetical concession." },
    { pattern: "として", meaning: "As (a role / capacity)", level: "N3", structure: "名 + として", examples: [{ jp: "留学生（りゅうがくせい）として日本（にほん）に来（き）た。", en: "I came to Japan as an exchange student." }], notes: "Marks a role, status, or standpoint." },
    { pattern: "一方（いっぽう）で", meaning: "On one hand / while", level: "N3", structure: "普通形 + 一方で", examples: [{ jp: "便利（べんり）な一方（いっぽう）で、危険（きけん）もある。", en: "While it's convenient, there are also dangers." }], notes: "Presents two contrasting aspects of one thing." },
    { pattern: "反面（はんめん）", meaning: "On the other hand", level: "N3", structure: "普通形 + 反面", examples: [{ jp: "この仕事（しごと）は楽（らく）な反面（はんめん）、給料（きゅうりょう）が安（やす）い。", en: "This job is easy but, on the other hand, pays little." }], notes: "Contrasts two opposite qualities." },
    { pattern: "くせに", meaning: "Even though (blame)", level: "N3", structure: "普通形 + くせに", examples: [{ jp: "知（し）っているくせに教（おし）えてくれない。", en: "Even though he knows, he won't tell me." }], notes: "のに with a nuance of criticism or reproach." },
    { pattern: "わりに", meaning: "Considering / for ~", level: "N3", structure: "普通形 + わりに", examples: [{ jp: "値段（ねだん）のわりにおいしい。", en: "It's delicious for the price." }], notes: "Result differs from what the standard would suggest." },
    { pattern: "うちに", meaning: "While / before it changes", level: "N3", structure: "動辞書形／ない／ている + うちに", examples: [{ jp: "熱（あつ）いうちに食（た）べてください。", en: "Please eat it while it's hot." }], notes: "Do something within a limited timeframe." },
    { pattern: "間（あいだ）に", meaning: "During / while ~", level: "N3", structure: "動ている／名の + 間に", examples: [{ jp: "留守（るす）の間（あいだ）に泥棒（どろぼう）が入（はい）った。", en: "A thief broke in while I was out." }], notes: "An action happens within a specific interval." },
    { pattern: "ついでに", meaning: "While at it / on the way", level: "N3", structure: "動辞書形／た／名の + ついでに", examples: [{ jp: "買（か）い物（もの）のついでに手紙（てがみ）を出（だ）した。", en: "While shopping, I also mailed a letter." }], notes: "Do a second thing on the occasion of the first." },
    { pattern: "に比（くら）べて", meaning: "Compared to ~", level: "N3", structure: "名 + に比べて", examples: [{ jp: "去年（きょねん）に比（くら）べて暑（あつ）い。", en: "It's hot compared to last year." }], notes: "Marks the basis of a comparison." },
    { pattern: "に加（くわ）えて", meaning: "In addition to ~", level: "N3", structure: "名 + に加えて", examples: [{ jp: "雨（あめ）に加（くわ）えて風（かぜ）も強（つよ）い。", en: "In addition to rain, the wind is strong too." }], notes: "Adds a further element." },
    { pattern: "をはじめ", meaning: "Starting with / including", level: "N3", structure: "名 + をはじめ", examples: [{ jp: "東京（とうきょう）をはじめ、多（おお）くの都市（とし）を訪（おとず）れた。", en: "I visited many cities, starting with Tokyo." }], notes: "Gives a representative example of a larger group." },
    { pattern: "に関（かん）して", meaning: "Regarding / concerning", level: "N3", structure: "名 + に関して", examples: [{ jp: "その件（けん）に関（かん）しては後（あと）で話（はな）す。", en: "I'll talk about that matter later." }], notes: "Formal version of について." },
    { pattern: "おかげで", meaning: "Thanks to ~", level: "N3", structure: "普通形／名の + おかげで", examples: [{ jp: "あなたのおかげで成功（せいこう）した。", en: "Thanks to you, I succeeded." }], notes: "Positive cause leading to a good result." },
    { pattern: "せいで", meaning: "Because of ~ (blame)", level: "N3", structure: "普通形／名の + せいで", examples: [{ jp: "雨（あめ）のせいで試合（しあい）が中止（ちゅうし）になった。", en: "The game was cancelled because of the rain." }], notes: "Negative cause leading to a bad result." },
    { pattern: "ようとする", meaning: "Try to / be about to ~", level: "N3", structure: "動意向形 + とする", examples: [{ jp: "出（で）かけようとしたとき、電話（でんわ）が鳴（な）った。", en: "Just as I was about to go out, the phone rang." }], notes: "An attempt or the moment right before an action." },
    { pattern: "通（とお）りに", meaning: "Just as / according to", level: "N3", structure: "動辞書形／た／名の + 通りに", examples: [{ jp: "説明書（せつめいしょ）の通（とお）りに組（く）み立（た）てる。", en: "Assemble it according to the manual." }], notes: "Exactly as described or instructed." },
    { pattern: "につれて", meaning: "As ~ (gradual change)", level: "N3", structure: "動辞書形／名 + につれて", examples: [{ jp: "年（とし）を取（と）るにつれて、体（からだ）が弱（よわ）くなる。", en: "As you age, your body weakens." }], notes: "Two things change proportionally together." },
    { pattern: "とともに", meaning: "Together with / as ~", level: "N3", structure: "名／動辞書形 + とともに", examples: [{ jp: "経済（けいざい）の発展（はってん）とともに生活（せいかつ）が変（か）わった。", en: "Life changed along with economic development." }], notes: "Simultaneous change or accompaniment." },
    { pattern: "ば〜ほど", meaning: "The more ~ the more ~", level: "N3", structure: "動ば形 + 動辞書形 + ほど", examples: [{ jp: "練習（れんしゅう）すればするほど上手（じょうず）になる。", en: "The more you practice, the better you get." }], notes: "Proportional increase between two things." },
    { pattern: "っぽい", meaning: "-ish / tends to be", level: "N3", structure: "名／動ます-stem + っぽい", examples: [{ jp: "彼（かれ）は忘（わす）れっぽい。", en: "He's forgetful." }], notes: "A strong characteristic or tendency." },
    { pattern: "だらけ", meaning: "Full of / covered in", level: "N3", structure: "名 + だらけ", examples: [{ jp: "部屋（へや）はほこりだらけだ。", en: "The room is full of dust." }], notes: "Covered with something, usually undesirable." },
    { pattern: "っぱなし", meaning: "Leaving ~ (unchanged/on)", level: "N3", structure: "動ます-stem + っぱなし", examples: [{ jp: "水（みず）を出（だ）しっぱなしにした。", en: "I left the water running." }], notes: "Leaving something in a state, often carelessly." },
    { pattern: "ことになっている", meaning: "It's a rule / arrangement that", level: "N3", structure: "動辞書形／ない + ことになっている", examples: [{ jp: "学校（がっこう）では制服（せいふく）を着（き）ることになっている。", en: "At school, you're supposed to wear a uniform." }], notes: "An established rule, schedule, or custom." },
    { pattern: "ものだから", meaning: "Because ~ (excuse)", level: "N3", structure: "普通形 + ものだから", examples: [{ jp: "道（みち）が込（こ）んでいたものだから、遅（おく）れました。", en: "Because the road was crowded, I was late." }], notes: "Gives a reason, often as an excuse." },
    { pattern: "わけだ", meaning: "No wonder / that's why", level: "N3", structure: "普通形 + わけだ", examples: [{ jp: "電気（でんき）が消（き）えている。留守（るす）なわけだ。", en: "The lights are off; that's why no one answers." }], notes: "A natural conclusion drawn from a situation." },
    { pattern: "ば良（よ）かった", meaning: "Should have ~ (regret)", level: "N3", structure: "動ば形 + 良かった", examples: [{ jp: "もっと勉強（べんきょう）すればよかった。", en: "I should have studied more." }], notes: "Regret about something not done." },
    { pattern: "たらどうですか", meaning: "Why don't you ~?", level: "N3", structure: "動た形 + らどうですか", examples: [{ jp: "医者（いしゃ）に行（い）ったらどうですか。", en: "Why don't you go to a doctor?" }], notes: "Offers advice or a suggestion." },
